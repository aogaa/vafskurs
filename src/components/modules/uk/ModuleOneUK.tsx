...
const buildingBlocks: { id: BuildingBlockId; label: string; description: string }[] = [
  ...
  },
  {
    id: "tilhorighet",
    label: "Приналежність",
    description: "Відчуття того, що тебе чекають, хочуть і включають.",
  },
  {
    id: "trygghet",
    label: "Безпека",
...
const supplementLayers: SupplementLayerData[] = [
  {
    ...
    description:
      "Як волонтер, ви додаєте щось особливе: присутність, спільноту та людський контакт. Ви не є частиною офіційної системи — ви теплий доповнення до неї.",
    animDelay: "300ms",
  },
  {
    id: "parorende",
    ...
    description:
      "Сім'я та близькі вносять любов, знання та наступність протягом тривалого часу. Вони знають людину так, як жодна служба не може замінити.",
    animDelay: "150ms",
  },
  {
    id: "ansatte",
    ...
    <article className="space-y-8">
      ...
      <TextSection title="Чому волонтерство важливе" icon="🌱">
        ...
        <p>
          ...
          відчути, що їх бачать, хочуть і що вони трохи менш самотні.
        </p>
      </TextSection>
      ...
      <TextSection title="Маленькі дії будують велику спільноту" icon="🏘️">
        ...
        <p>
          ...
          в той момент. Розмова може знизити поріг для повторного повернення.
      ...
      <TextSection title="Безпека починається з того, що ми знаємо одне одного" icon="🔗">
        ...
        <p>
          ...
          між людьми. Хто вітає вас? Хто помічає, якщо ви не прийшли, як зазвичай?
      ...
      <TextSection title="Волонтерство є скрізь" icon="🌍">
        ...
        <p>Деякі допомагають часто. Деякі — іноді. У деяких великий досвід. Інші — зовсім нові.</p>
        <p>
        ...
        <section className="space-y-8" aria-live="polite">
          ...
          <Card className="p-6 md:p-8">
            ...
            <div className="mt-5 max-w-4xl space-y-4 text-base leading-8 text-slate md:text-lg">
              ...
              <p>
                Коли ви знаєте свою роль, легше вносити внесок із впевненістю,
