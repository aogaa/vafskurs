...
type ModuleCardTranslatableProps = {
...
export function ModuleCardTranslatable({
  courseModule,
  status,
  urlPrefix,
  partLabel,
  statusCopy,
}: ModuleCardTranslatableProps) {
