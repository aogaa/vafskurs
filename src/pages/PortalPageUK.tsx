...
const courseCards = [
  {
    ...
    description:
      "Практичний курс про роль волонтера, здорові межі та безпечний вибір у роботі з людьми, громадою та муніципальними службами.",
    to: "/ukrainsk/trygg-som-frivillig",
  },
];

export function PortalPageUK() {
  return (
    <div className="bg-harbor text-white">
      <section className="relative isolate min-h-[70vh] overflow-hidden">
        <img
          src={heroindex}
          alt="Навчальний портал для волонтерів — навчання, спільнота та місцева громада"
